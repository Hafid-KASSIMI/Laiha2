...
public class Absence6Metrics extends AbsenceListMetrics {
        
    public Absence6Metrics() {
        super();
        template = "ABSENCE_6";
        ...
        week = new XRectangle("M3", 0, 0);
        year = new XRectangle("AQ1", 0, 0);
        bureau = new XRectangle("AQ2", 0, 0);
        group = new XRectangle("AQ3", 0, 0);
