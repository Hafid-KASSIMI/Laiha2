...
public class List1Metrics extends ListMetrics {
    ...
    public List1Metrics() {
        ...
        year = new XRectangle("F2", 0, 0);
        lastColumnLabel = new XRectangle("G4", 0, 0);
        ...
        studentRow.setGender(new XRectangle("D5", 0, 0));
        ...
        studentRow.setBirthDate(new XRectangle("E5", 0, 0, new Format(12, XAvailableFonts.TIMES)));
        studentRow.getBirthDate().getFormat().setBorders(0, 1, 1, 1);
        studentRow.getBirthDate().getFormat().setDataType(DATA_TYPE.DATE);
        studentRow.setBirthPlace(new XRectangle("F5", 0, 0, new Format(12, XAvailableFonts.TIMES)));
        studentRow.getBirthPlace().getFormat().setBorders(0, 1, 1, 1);
        studentRow.setAdditional(new XRectangle("G5", 0, 0, new Format(12, XAvailableFonts.TIMES, true)));
