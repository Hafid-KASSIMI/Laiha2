...
public class Marks4Metrics extends MarksMetrics {
    ...
    public Marks4Metrics() {
        ...
        lastColumnLabel = new XRectangle("AC7", 0, 0);
        ...
        studentRow.getSecondName().setColSpan(6);
        studentRow.setFirstName(new XRectangle("M8", 0, 0));
        studentRow.getFirstName().setFormat(studentRow.getSecondName().getFormat());
        studentRow.getFirstName().setColSpan(6);
        studentRow.setMark1(new XRectangle("S8", 0, 0, new Format(12, XAvailableFonts.TIMES)));
        ...
        studentRow.setAi(new XRectangle("AA8", 0, 0));
        studentRow.getAi().setFormat(studentRow.getMark1().getFormat());
        studentRow.getAi().setColSpan(2);
        studentRow.setAdditional(new XRectangle("AC8", 0, 0, new Format(12, XAvailableFonts.TIMES)));
