...
import lp.Settings;
import lp.models.templates.workbooks.metrics.Absence0Metrics;
 ...
 * @author H. KASSIMI
 */
public class Absence0 extends AbsenceWorkbook {
    
    private final String separator = "\n";
    
    public Absence0() {
        super();
        sheetMetrics = new Absence0Metrics();
        initializeTemplate();
    }
    ...
    protected void add1PageGroup(Group g, XSSFSheet sht, WEEK week) {
        ...
        sht.getRow(sht.getLastRowNum()).getCell(sheetMetrics.getMessage().getX(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.PREF_TEMPORARY.get(sheetMetrics.getTemplate() + "_MESSAGE"));
