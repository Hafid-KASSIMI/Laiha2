...
import lp.Settings;
import lp.models.templates.workbooks.metrics.Absence3Metrics;
 ...
 * @author H. KASSIMI
 */
public class Absence3 extends AbsenceWorkbook {
    
    private final String separator = "\n";
    
    public Absence3() {
        super();
        sheetMetrics = new Absence3Metrics();
        initializeTemplate();
    }
    ...
    protected void add1PageGroup(Group g, XSSFSheet sht, WEEK week) {
        ...
        sht.getRow(sheetMetrics.getKingdom().getY()).getCell(sheetMetrics.getKingdom().getX(), Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(Settings.PREF_TEMPORARY.get("KINGDOM-AR").replaceAll("%nl%", "\n"));
    }
