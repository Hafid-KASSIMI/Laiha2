...
import lp.Settings;
import lp.models.templates.workbooks.metrics.Marks3Metrics;
...
public class Marks3 extends MarksWorkbook {
    
    private final String separator;
    
    public Marks3() {
        super();
        sheetMetrics = new Marks3Metrics();
    ...
    protected void add1PageGroupNoMarks(Group group, XSSFSheet sheet, int start, int stuCount) {
        sheet.getRow(((Marks3Metrics) sheetMetrics).getTeacher().getY()).getCell(((Marks3Metrics) sheetMetrics).getTeacher().getX()).setCellValue(Settings.PREF_TEMPORARY.get(sheetMetrics.getTemplate() + "_EMPTY_STRING"));
        sheet.getRow(((Marks3Metrics) sheetMetrics).getMatter().getY()).getCell(((Marks3Metrics) sheetMetrics).getMatter().getX()).setCellValue(Settings.PREF_TEMPORARY.get(sheetMetrics.getTemplate() + "_EMPTY_STRING"));
        sheet.getRow(((Marks3Metrics) sheetMetrics).getSemester().getY()).getCell(((Marks3Metrics) sheetMetrics).getSemester().getX()).setCellValue(Settings.PREF_TEMPORARY.get(sheetMetrics.getTemplate() + "_EMPTY_STRING"));
    ...
    protected void add1PageGroupWithMarks(Group group, XSSFSheet sheet, int start, int stuCount, 
        ...
        sheet.getRow(((Marks3Metrics) sheetMetrics).getTeacher().getY()).getCell(((Marks3Metrics) sheetMetrics).getTeacher().getX()).setCellValue(group.getTeacher(matter.getCode()));
        sheet.getRow(((Marks3Metrics) sheetMetrics).getMatter().getY()).getCell(((Marks3Metrics) sheetMetrics).getMatter().getX()).setCellValue(matter.getLabel());
        sheet.getRow(((Marks3Metrics) sheetMetrics).getSemester().getY()).getCell(((Marks3Metrics) sheetMetrics).getSemester().getX()).setCellValue(semester.intValue());
        placeCommonHeader(group, sheet);
    ...
    private void placeCommonHeader(Group group, XSSFSheet sheet) {
        sheet.getRow(sheetMetrics.getSchoolInfos().getY()).getCell(sheetMetrics.getSchoolInfos().getX()).setCellValue(group.getLevel().getSchool().getAcademy() + separator + group.getLevel().getSchool().getDirection() + separator + group.getLevel().getSchool().getSchool());
        ...
        sheet.getRow(((Marks3Metrics) sheetMetrics).getTeacherLbl().getY()).getCell(((Marks3Metrics) sheetMetrics).getTeacherLbl().getX()).setCellValue(Settings.PREF_TEMPORARY.get("MARKS_TEACHER_LABEL"));
        sheet.getRow(((Marks3Metrics) sheetMetrics).getMatterLbl().getY()).getCell(((Marks3Metrics) sheetMetrics).getMatterLbl().getX()).setCellValue(Settings.PREF_TEMPORARY.get("MARKS_MATTER_LABEL"));
        sheet.getRow(((Marks3Metrics) sheetMetrics).getSemesterLbl().getY()).getCell(((Marks3Metrics) sheetMetrics).getSemesterLbl().getX()).setCellValue(Settings.PREF_TEMPORARY.get("MARKS_SEMESTER_LABEL"));
        sheet.getRow(((Marks3Metrics) sheetMetrics).getYearLbl().getY()).getCell(((Marks3Metrics) sheetMetrics).getYearLbl().getX()).setCellValue(Settings.PREF_TEMPORARY.get("MARKS_YEAR_LABEL"));
    }
