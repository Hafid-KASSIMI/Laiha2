...
import lp.models.templates.pdffiles.metrics.Absence1Metrics;
import lp.Settings;
import lp.util.Calendar.WEEK;
import net.mdrassty.object.Group;
import org.apache.pdfbox.pdmodel.PDPage;

public class Absence1 extends AbsencePDF {
    
    public Absence1() {
        super();
        pageMetrics = new Absence1Metrics();
    ...
    protected void add1PageGroup(Group g, PDPage page, WEEK week) {
        ...
        pdf.wrapNResizeText(pageMetrics.getMessage(), page, Settings.PREF_TEMPORARY.get(pageMetrics.getTemplate() + "_MESSAGE"));
