...
import lp.Settings;
import lp.models.templates.pdffiles.metrics.Marks4Metrics;
...
public class Marks4 extends MarksPDF {
    
    public Marks4() {
        super();
        pageMetrics = new Marks4Metrics();
    ...
    protected void add1PageGroupNoMarks(Group group, PDPage page, int start, int stuCount) {
        ...
        pdf.placeString(((Marks4Metrics) pageMetrics).getTeacher(), page, Settings.PREF_TEMPORARY.get(pageMetrics.getTemplate() + "_EMPTY_STRING"));
        pdf.placeString(((Marks4Metrics) pageMetrics).getMatter(), page, Settings.PREF_TEMPORARY.get(pageMetrics.getTemplate() + "_EMPTY_STRING"));
        pdf.placeString(((Marks4Metrics) pageMetrics).getSemester(), page, Settings.PREF_TEMPORARY.get(pageMetrics.getTemplate() + "_EMPTY_STRING"));
    ...
    protected void add1PageGroupWithMarks(Group group, PDPage page, int start, int stuCount, 
        ...
        pdf.placeString(((Marks4Metrics) pageMetrics).getTeacher(), page, group.getTeacher(matter.getCode()));
        pdf.placeString(((Marks4Metrics) pageMetrics).getMatter(), page, matter.getLabel());
        pdf.placeString(((Marks4Metrics) pageMetrics).getSemester(), page, semester.intValue() + "");
        placeCommonHeader(group, page);
    }
    ...
    private void placeCommonHeader(Group group, PDPage page) {
        ...
        pdf.placeString(((Marks4Metrics) pageMetrics).getYearLbl(), page, Settings.PREF_TEMPORARY.get("MARKS_YEAR_LABEL"));
        ...
        pdf.placeString(((Marks4Metrics) pageMetrics).getTeacherLbl(), page, Settings.PREF_TEMPORARY.get("MARKS_TEACHER_LABEL"));
        pdf.placeString(((Marks4Metrics) pageMetrics).getMatterLbl(), page, Settings.PREF_TEMPORARY.get("MARKS_MATTER_LABEL"));
        pdf.placeString(((Marks4Metrics) pageMetrics).getSemesterLbl(), page, Settings.PREF_TEMPORARY.get("MARKS_SEMESTER_LABEL"));
    }
}
