...
public class Absence3Metrics extends AbsenceMetrics {
    ...
    public Absence3Metrics() {
        ...
        template = "ABSENCE_3";
        schoolInfos.setFormat(9, PAvailableFonts.MAGHRIBI);
        ...
        kingdom =  new PDFRectangle(A4_PAPER.getLandscapeHeight());
        kingdom.reset(731.040f, 20.279f, 90f, 55.744f);
        kingdom.setFormat(8, PAvailableFonts.MAGHRIBI);
        kingdom.getFormat().setHAlignment(HORIZONTAL_ALIGNMENT.LEFT);
        schoolInfos.reset(583.785f, 20.279f, 100f, 55.744f);
        schoolInfos.getFormat().setFontSize(8);
        schoolInfos.getFormat().setHAlignment(HORIZONTAL_ALIGNMENT.RIGHT);
        title.reset(246.105f, 20.279f, 337.680f, 31.623f);
